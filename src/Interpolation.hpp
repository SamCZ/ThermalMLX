...
void set_point(float *p, uint8_t rows, uint8_t cols, int16_t x, int16_t y, float f);
void get_adjacents_1d(float *src, float *dest, uint8_t rows, uint8_t cols,
	int16_t x, int16_t y);
inline void get_adjacents_2d(float *src, float *dest, uint8_t rows, uint8_t cols,
	int16_t x, int16_t y);
...
void set_point(float *p, uint8_t rows, uint8_t cols, int16_t x, int16_t y,
	float f) {
	if ((x < 0) || (x >= cols))
		return;
	if ((y < 0) || (y >= rows))
...
void get_adjacents_1d(float *src, float *dest, uint8_t rows, uint8_t cols, int16_t x, int16_t y) {
...
inline void get_adjacents_2d(float *src, float *dest, uint8_t rows, uint8_t cols, int16_t x, int16_t y) {
	// Serial.print("("); Serial.print(x); Serial.print(", "); Serial.print(y);
	// Serial.println(")");
	float arr[4];
